...
namespace Zshot.Features.Update;
...
public sealed partial class UpdateWindow : WindowEx
{
    ...
    public UpdateWindow()
    {
        ...
        this.Closed += (_, _) =>
        {
            ...
            InAppToast.MainWindow?.Warning(null, Lang.Zshot_UpdateFailed, 5000);
        };
    }
    ...
    private void Hyperlink_Click(object sender, RoutedEventArgs e)
    {
        ...
        {
            "release" => $"https://github.com/Zyl0812/Zshot/releases/tag/{_release.TagName}",
    ...
    private async Task RunUpdateAsync(bool forceFull)
    {
        ...
        catch (Exception ex)
        {
            ...
            ErrorMessage = Lang.Zshot_UpdateFailed;
            HasError = Visibility.Visible;
            Button_Update.IsEnabled = true;
            Button_Remind.IsEnabled = true;
            if (!_userClosed) InAppToast.MainWindow?.Error(ex, Lang.Zshot_UpdateFailed);
        }
    }
