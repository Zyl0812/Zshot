...
using Zshot.Features.Background;
...
public sealed partial class AppearanceSetting : PageBase
{
    ...
    {
        2 => Lang.Zshot_WallpaperChooseVideo,
        3 => Lang.Zshot_WallpaperChooseFolder,
        _ => Lang.Zshot_WallpaperChooseImage,
    };


    public string WallpaperValue => AppConfig.WallpaperMode switch
    {
        2 => string.IsNullOrWhiteSpace(AppConfig.WallpaperVideoFile) ? Lang.Zshot_PathNone : AppConfig.WallpaperVideoFile!,
        3 => string.IsNullOrWhiteSpace(AppConfig.WallpaperFolder) ? Lang.Zshot_PathNone : AppConfig.WallpaperFolder!,
        _ => string.IsNullOrWhiteSpace(AppConfig.WallpaperFile) ? Lang.Zshot_PathNone : AppConfig.WallpaperFile!,
    };
    ...
    public string NowPlayingDisplay => string.IsNullOrEmpty(NowPlayingText) ? "" : $"{Lang.Zshot_WallpaperNowPlaying}: {NowPlayingText}";
